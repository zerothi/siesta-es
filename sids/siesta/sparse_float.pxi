...
cdef tosparse1_float(int is_gamma, int no_u, 
    ...
    np.ndarray[DFLOAT_t, ndim=1, mode='c'] k,
    np.ndarray[DFLOAT_t, ndim=1, mode='c'] m):
...
@cython.cdivision(True)
cdef tosparse1_float_off(int is_gamma, int no_u, 
    np.ndarray[DINT_t,    ndim=1, mode='c'] n_col,
    np.ndarray[DINT_t,    ndim=1, mode='c'] l_ptr,
    np.ndarray[DINT_t,    ndim=1, mode='c'] l_col,
    np.ndarray[DFLOAT_t, ndim=2, mode='c'] off,
    np.ndarray[DINT_t,    ndim=1, mode='c'] sp_ptr,
    np.ndarray[DINT_t,    ndim=1, mode='c'] sp_col,
    np.ndarray[DFLOAT_t, ndim=1, mode='c'] k,
    np.ndarray[DFLOAT_t, ndim=1, mode='c'] m):
...
@cython.cdivision(True)
cdef tosparse2_float(int is_gamma, int no_u, 
    np.ndarray[DINT_t,    ndim=1, mode='c'] n_col,
    np.ndarray[DINT_t,    ndim=1, mode='c'] l_ptr,
    np.ndarray[DINT_t,    ndim=1, mode='c'] l_col,
    np.ndarray[DFLOAT_t, ndim=2, mode='c'] xij,
    ...
    np.ndarray[DINT_t,    ndim=1, mode='c'] sp_col,
    np.ndarray[DFLOAT_t, ndim=1, mode='c'] k,
    np.ndarray[DFLOAT_t, ndim=1, mode='c'] m1,
    np.ndarray[DFLOAT_t, ndim=1, mode='c'] m2):
...
@cython.cdivision(True)
cdef tosparse2_float_off(int is_gamma, int no_u, 
    np.ndarray[DINT_t,    ndim=1, mode='c'] n_col,
    np.ndarray[DINT_t,    ndim=1, mode='c'] l_ptr,
    np.ndarray[DINT_t,    ndim=1, mode='c'] l_col,
    np.ndarray[DFLOAT_t, ndim=2, mode='c'] off,
...
@cython.cdivision(True)
cdef todense1_float(int is_gamma, int no_u, 
    np.ndarray[DINT_t,   ndim=1, mode='c'] n_col,
    np.ndarray[DINT_t,   ndim=1, mode='c'] l_ptr,
    np.ndarray[DINT_t,   ndim=1, mode='c'] l_col,
    np.ndarray[DFLOAT_t, ndim=2, mode='c'] xij,
...
@cython.cdivision(True)
cdef todense2_float(int is_gamma, int no_u, 
    np.ndarray[DINT_t,   ndim=1, mode='c'] n_col,
    np.ndarray[DINT_t,   ndim=1, mode='c'] l_ptr,
    np.ndarray[DINT_t,   ndim=1, mode='c'] l_col,
    np.ndarray[DFLOAT_t, ndim=2, mode='c'] xij,
...
@cython.cdivision(True)
cdef todense1_float_off(int is_gamma, int no_u, 
    np.ndarray[DINT_t,   ndim=1, mode='c'] n_col,
    np.ndarray[DINT_t,   ndim=1, mode='c'] l_ptr,
    np.ndarray[DINT_t,   ndim=1, mode='c'] l_col,
    np.ndarray[DFLOAT_t, ndim=2, mode='c'] off,
...
@cython.cdivision(True)
cdef todense2_float_off(int is_gamma, int no_u, 
    np.ndarray[DINT_t,   ndim=1, mode='c'] n_col,
    np.ndarray[DINT_t,   ndim=1, mode='c'] l_ptr,
    np.ndarray[DINT_t,   ndim=1, mode='c'] l_col,
    np.ndarray[DFLOAT_t, ndim=2, mode='c'] off,
